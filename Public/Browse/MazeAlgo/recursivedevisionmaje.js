function recursiveDivisionMaze(board, rowstart, rowEnd, colStart, colEnd, orientation, surrondingWalls, type){
...
if (!surrondingWalls) {
    ...
    if(board.object) relevanatIDs.push(board.object);
...
let randomColIndex = Math.floor(mah.random() * possibleCols.length);
